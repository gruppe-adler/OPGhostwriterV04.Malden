/*
[ist Sieg, Musik abspielen, Tasks abschließen] call GRAD_missionControl_fnc_endMission;
...
_this spawn {
    ...
    _layerNoise cutRsc ["Default","plain"];
    _layerInterlacing cutRsc ["Default","plain"];
    _layerStatic cutRsc ["Default","plain"];
    _layerEnd cutRsc ["Default","plain"];
